...
//     console.log(userAuthenticationService, '__userAuthenticationService__');
...
export default class ExtensionManager {
  ...
  private _extensionLifeCycleHooks: Record<string, any>;
  private dataSourceMap: Record<string, unknown>;
  private dataSourceDefs: Record<string, unknown>;
  private defaultDataSourceName: string;
  private activeDataSource: string | undefined;
